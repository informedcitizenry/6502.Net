...
public sealed partial class M65xxInstructionEncoder
{
    ...
    private static readonly Dictionary<int, M6xxOpcode> s_45gs02Opcodes = new()
    {
        ...
        { SyntaxParser.DEW, new M6xxOpcode(  Bad,  Bad,  Bad,  Bad, 0xC3,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad,  Bad) },
    ...
    private static readonly Dictionary<int, Instruction> s_65ce02Disassembly = new()
    {
        ...
        { 0xc3, new Instruction("dew ${0:x4}", 0xc3, 3) },
