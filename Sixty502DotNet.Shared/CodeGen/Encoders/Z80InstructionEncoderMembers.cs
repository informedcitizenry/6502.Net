...
public sealed partial class Z80InstructionEncoder
{
    ...
    private static readonly Dictionary<int, Instruction> s_z80AllOpcodes = new()
    {
        ...
        { 0x80, new Instruction("add a,b", 0x80,    1) },
        { 0x81, new Instruction("add a,c", 0x81,    1) },
        { 0x82, new Instruction("add a,d", 0x82,    1) },
        { 0x83, new Instruction("add a,e", 0x83,    1) },
        { 0x84, new Instruction("add a,h", 0x84,    1) },
        { 0x85, new Instruction("add a,l", 0x85,    1) },
        { 0x86, new Instruction("add a,(hl)", 0x86,    1) },
        { 0x87, new Instruction("add a,a", 0x87,    1) },
        ...
        { 0x8f, new Instruction("adc a,a", 0x8f,    1) },
        ...
        { 0xa0, new Instruction("and b", 0xa0,    1) },
        { 0xa1, new Instruction("and c", 0xa1,    1) },
        { 0xa2, new Instruction("and d", 0xa2,    1) },
        { 0xa3, new Instruction("and e", 0xa3,    1) },
        { 0xa4, new Instruction("and h", 0xa4,    1) },
        { 0xa5, new Instruction("and l", 0xa5,    1) },
        { 0xa6, new Instruction("and (hl)", 0xa6,    1) },
        { 0xa7, new Instruction("and a", 0xa7,    1) },
        { 0xa8, new Instruction("xor b", 0xa8,    1) },
        { 0xa9, new Instruction("xor c", 0xa9,    1) },
        { 0xaa, new Instruction("xor d", 0xaa,    1) },
        { 0xab, new Instruction("xor e", 0xab,    1) },
        { 0xac, new Instruction("xor h", 0xac,    1) },
        { 0xad, new Instruction("xor l", 0xad,    1) },
        { 0xae, new Instruction("xor (hl)", 0xae,    1) },
        { 0xaf, new Instruction("xor a", 0xaf,    1) },
        { 0xb0, new Instruction("or b", 0xb0,    1) },
        { 0xb1, new Instruction("or c", 0xb1,    1) },
        { 0xb2, new Instruction("or d", 0xb2,    1) },
        { 0xb3, new Instruction("or e", 0xb3,    1) },
        { 0xb4, new Instruction("or h", 0xb4,    1) },
        { 0xb5, new Instruction("or l", 0xb5,    1) },
        { 0xb6, new Instruction("or (hl)", 0xb6,    1) },
        { 0xb7, new Instruction("or a", 0xb7,    1) },
        { 0xb8, new Instruction("cp b", 0xb8,    1) },
        { 0xb9, new Instruction("cp c", 0xb9,    1) },
        { 0xba, new Instruction("cp d", 0xba,    1) },
        { 0xbb, new Instruction("cp e", 0xbb,    1) },
        { 0xbc, new Instruction("cp h", 0xbc,    1) },
        { 0xbd, new Instruction("cp l", 0xbd,    1) },
        { 0xbe, new Instruction("cp (hl)", 0xbe,    1) },
        { 0xbf, new Instruction("cp a", 0xbf,    1) },
        ...
        { 0x63ed, new Instruction("ld (${0:x4}),hl", 0x63ed, 4) },
        ...
        { 0x6bed, new Instruction("ld hl,(${0:x4})", 0x6bed, 4) },
        ...
        { 0x04dd, new Instruction("inc b", 0x04dd, 2) },
        { 0x05dd, new Instruction("dec b", 0x05dd, 2) },
        { 0x06dd, new Instruction("ld b,${0:x2}", 0x06dd, 3) }, 
        { 0x09dd, new Instruction("add ix,bc", 0x09dd,   2) },
        { 0x0cdd, new Instruction("inc c", 0x0cdd, 2) },
        { 0x0ddd, new Instruction("dec c", 0x0ddd, 2) },
        { 0x0edd, new Instruction("ld c,${0:x2}", 0x0edd, 3) },
        { 0x14dd, new Instruction("inc d", 0x14dd, 2) },
        { 0x15dd, new Instruction("dec d", 0x15dd, 2) },
        { 0x16dd, new Instruction("ld d,${0:x2}", 0x16dd, 2) },
        { 0x19dd, new Instruction("add ix,de", 0x19dd,   2) },
        { 0x1cdd, new Instruction("inc e", 0x1cdd, 2) },
        { 0x1ddd, new Instruction("dec e", 0x1ddd, 2) },
        { 0x1edd, new Instruction("ld e,${0:x2}", 0x1edd, 3) },
        ...
        { 0x3cdd, new Instruction("inc a", 0x3cdd, 2) },
        { 0x3ddd, new Instruction("dec a", 0x3ddd, 2) },
        { 0x3edd, new Instruction("ld a,${0:x2}", 0x3edd, 3) },
        { 0x40dd, new Instruction("ld b,b", 0x40dd, 2) },
        { 0x41dd, new Instruction("ld b,c", 0x41dd, 2) },
        { 0x42dd, new Instruction("ld b,d", 0x42dd, 2) },
        { 0x43dd, new Instruction("ld b,e", 0x43dd, 2) },
        ...
        { 0x47dd, new Instruction("ld b,a", 0x47dd, 2) },
        { 0x48dd, new Instruction("ld c,b", 0x48dd, 2) },
        { 0x49dd, new Instruction("ld c,c", 0x49dd, 2) },
        { 0x4add, new Instruction("ld c,d", 0x4add, 2) },
        { 0x4bdd, new Instruction("ld c,e", 0x4bdd, 2) },
        ...
        { 0x4fdd, new Instruction("ld c,a", 0x4fdd, 2) },
        { 0x50dd, new Instruction("ld d,b", 0x50dd, 2) },
        { 0x51dd, new Instruction("ld d,c", 0x51dd, 2) },
        { 0x52dd, new Instruction("ld d,d", 0x52dd, 2) },
        { 0x53dd, new Instruction("ld d,e", 0x53dd, 2) },
        ...
        { 0x57dd, new Instruction("ld d,a", 0x57dd, 2) },
        { 0x58dd, new Instruction("ld e,b", 0x58dd, 2) },
        { 0x59dd, new Instruction("ld e,c", 0x59dd, 2) },
        { 0x5add, new Instruction("ld e,d", 0x5add, 2) },
        { 0x5bdd, new Instruction("ld e,e", 0x5bdd, 2) },
        ...
        { 0x5fdd, new Instruction("ld e,a", 0x5fdd, 2) },
        ...
        { 0x78dd, new Instruction("ld a,b", 0x78dd, 2) },
        { 0x79dd, new Instruction("ld a,c", 0x79dd, 2) },
        { 0x7add, new Instruction("ld a,d", 0x7add, 2) },
        { 0x7bdd, new Instruction("ld a,e", 0x7bdd, 2) },
        ...
        { 0x7fdd, new Instruction("ld a,a", 0x7fdd, 2) },
        { 0x80dd, new Instruction("add b", 0x80dd, 2) },
        { 0x81dd, new Instruction("add c", 0x81dd, 2) },
        { 0x82dd, new Instruction("add d", 0x82dd, 2) },
        { 0x83dd, new Instruction("add e", 0x83dd, 2) },
        ...
        { 0x87dd, new Instruction("add a,a", 0x87dd, 2) },
        { 0x88dd, new Instruction("adc a,b", 0x58dd, 2) },
        { 0x89dd, new Instruction("adc a,c", 0x59dd, 2) },
        { 0x8add, new Instruction("adc a,d", 0x5add, 2) },
        { 0x8bdd, new Instruction("adc a,e", 0x8bdd, 2) },
        ...
        { 0x90dd, new Instruction("sub b", 0x90dd, 2) },
        { 0x91dd, new Instruction("sub c", 0x91dd, 2) },
        { 0x92dd, new Instruction("sub d", 0x92dd, 2) },
        { 0x93dd, new Instruction("sub e", 0x93dd, 2) },
        ...
        { 0x97dd, new Instruction("sub a", 0x97dd, 2) },
        { 0x98dd, new Instruction("sbc a,b", 0x98dd, 2) },
        { 0x99dd, new Instruction("sbc a,c", 0x99dd, 2) },
        { 0x9add, new Instruction("sbc a,d", 0x9add, 2) },
        { 0x9bdd, new Instruction("sbc a,e", 0x9bdd, 2) },
        ...
        { 0x9fdd, new Instruction("sbc a,a", 0x9fdd, 2) },
        { 0xa0dd, new Instruction("and b", 0xa0dd, 2) },
        { 0xa1dd, new Instruction("and c", 0xa1dd, 2) },
        { 0xa2dd, new Instruction("and d", 0xa2dd, 2) },
        { 0xa3dd, new Instruction("and e", 0xa3dd, 2) },
        ...
        { 0xa7dd, new Instruction("and a", 0xa7dd, 2) },
        { 0xa8dd, new Instruction("xor b", 0xa9dd, 2) },
        { 0xa9dd, new Instruction("xor c", 0xaadd, 2) },
        { 0xaadd, new Instruction("xor d", 0xabdd, 2) },
        { 0xabdd, new Instruction("xor e", 0xacdd, 2) },
        ...
        { 0xafdd, new Instruction("xor a", 0xafdd, 2) },
        { 0xb0dd, new Instruction("or b", 0xb0dd, 2) },
        { 0xb1dd, new Instruction("or c", 0xb1dd, 2) },
        { 0xb2dd, new Instruction("or d", 0xb2dd, 2) },
        { 0xb3dd, new Instruction("or e", 0xb3dd, 2) },
        { 0xb4dd, new Instruction("or ixh", 0xb4dd,   2) },
        { 0xb5dd, new Instruction("or ixl", 0xb5dd,   2) },
        { 0xb6dd, new Instruction("or (ix+${0:x2})", 0xb6dd,   3) },
        { 0xb7dd, new Instruction("or a", 0xb7dd, 2) },
        { 0xb8dd, new Instruction("cp b", 0xb9dd, 2) },
        { 0xb9dd, new Instruction("cp c", 0xbadd, 2) },
        { 0xbadd, new Instruction("cp d", 0xbbdd, 2) },
        { 0xbbdd, new Instruction("cp e", 0xbcdd, 2) },
        { 0xbcdd, new Instruction("cp ixh", 0xbcdd,   2) },
        { 0xbddd, new Instruction("cp ixl", 0xbddd,   2) },
        { 0xbedd, new Instruction("cp (ix+${0:x2})", 0xbedd,   3) },
        { 0xbfdd, new Instruction("cp a", 0xbfdd, 2) },
        ...
        { 0x04fd, new Instruction("inc b", 0x04fd, 2) },
        { 0x05fd, new Instruction("dec b", 0x05fd, 2) },
        { 0x06fd, new Instruction("ld b,${0:x2}", 0x06fd, 3) }, 
        { 0x09fd, new Instruction("add iy,bc", 0x09fd,   2) },
        { 0x0cfd, new Instruction("inc c", 0x0cfd, 2) },
        { 0x0dfd, new Instruction("dec c", 0x0dfd, 2) },
        { 0x0efd, new Instruction("ld c,${0:x2}", 0x0efd, 3) },
        { 0x14fd, new Instruction("inc d", 0x14fd, 2) },
        { 0x15fd, new Instruction("dec d", 0x15fd, 2) },
        { 0x16fd, new Instruction("ld d,${0:x2}", 0x16fd, 2) },
        { 0x19fd, new Instruction("add iy,de", 0x19fd,   2) },
        { 0x1cfd, new Instruction("inc e", 0x1cfd, 2) },
        { 0x1dfd, new Instruction("dec e", 0x1dfd, 2) },
        { 0x1efd, new Instruction("ld e,${0:x2}", 0x1efd, 3) },
        ...
        { 0x3cfd, new Instruction("inc a", 0x3cfd, 2) },
        { 0x3dfd, new Instruction("dec a", 0x3dfd, 2) },
        { 0x3efd, new Instruction("ld a,${0:x2}", 0x3efd, 3) },
        { 0x40fd, new Instruction("ld b,b", 0x40fd, 2) },
        { 0x41fd, new Instruction("ld b,c", 0x41fd, 2) },
        { 0x42fd, new Instruction("ld b,d", 0x42fd, 2) },
        { 0x43fd, new Instruction("ld b,e", 0x43fd, 2) },
        ...
        { 0x47fd, new Instruction("ld b,a", 0x47fd, 2) },
        { 0x48fd, new Instruction("ld c,b", 0x48fd, 2) },
        { 0x49fd, new Instruction("ld c,c", 0x49fd, 2) },
        { 0x4afd, new Instruction("ld c,d", 0x4afd, 2) },
        { 0x4bfd, new Instruction("ld c,e", 0x4bfd, 2) },
        ...
        { 0x4ffd, new Instruction("ld c,a", 0x4ffd, 2) },
        { 0x50fd, new Instruction("ld d,b", 0x50fd, 2) },
        { 0x51fd, new Instruction("ld d,c", 0x51fd, 2) },
        { 0x52fd, new Instruction("ld d,d", 0x52fd, 2) },
        { 0x53fd, new Instruction("ld d,e", 0x53fd, 2) },
        ...
        { 0x57fd, new Instruction("ld d,a", 0x57fd, 2) },
        { 0x58fd, new Instruction("ld e,b", 0x58fd, 2) },
        { 0x59fd, new Instruction("ld e,c", 0x59fd, 2) },
        { 0x5afd, new Instruction("ld e,d", 0x5afd, 2) },
        { 0x5bfd, new Instruction("ld e,e", 0x5bfd, 2) },
        ...
        { 0x5ffd, new Instruction("ld e,a", 0x5ffd, 2) },
        ...
        { 0x78fd, new Instruction("ld a,b", 0x78fd, 2) },
        { 0x79fd, new Instruction("ld a,c", 0x79fd, 2) },
        { 0x7afd, new Instruction("ld a,d", 0x7afd, 2) },
        { 0x7bfd, new Instruction("ld a,e", 0x7bfd, 2) },
        { 0x7cfd, new Instruction("ld a,iyh", 0x7cfd,   2) },
        { 0x7dfd, new Instruction("ld a,iyl", 0x7dfd,   2) },
        { 0x7efd, new Instruction("ld a,(iy+${0:x2})", 0x7efd,   3) },
        { 0x7ffd, new Instruction("ld a,a", 0x7ffd, 2) },
        { 0x80fd, new Instruction("add b", 0x80fd, 2) },
        { 0x81fd, new Instruction("add c", 0x81fd, 2) },
        { 0x82fd, new Instruction("add d", 0x82fd, 2) },
        { 0x83fd, new Instruction("add e", 0x83fd, 2) },
        ...
        { 0x87fd, new Instruction("add a,a", 0x87fd, 2) },
        { 0x88fd, new Instruction("adc a,b", 0x58fd, 2) },
        { 0x89fd, new Instruction("adc a,c", 0x59fd, 2) },
        { 0x8afd, new Instruction("adc a,d", 0x5afd, 2) },
        { 0x8bfd, new Instruction("adc a,e", 0x8bfd, 2) },
        ...
        { 0x90fd, new Instruction("sub b", 0x90fd, 2) },
        { 0x91fd, new Instruction("sub c", 0x91fd, 2) },
        { 0x92fd, new Instruction("sub d", 0x92fd, 2) },
        { 0x93fd, new Instruction("sub e", 0x93fd, 2) },
        ...
        { 0x97fd, new Instruction("sub a", 0x97fd, 2) },
        { 0x98fd, new Instruction("sbc a,b", 0x98fd, 2) },
        { 0x99fd, new Instruction("sbc a,c", 0x99fd, 2) },
        { 0x9afd, new Instruction("sbc a,d", 0x9afd, 2) },
        { 0x9bfd, new Instruction("sbc a,e", 0x9bfd, 2) },
        ...
        { 0x9ffd, new Instruction("sbc a,a", 0x9ffd, 2) },
        { 0xa0fd, new Instruction("and b", 0xa0fd, 2) },
        { 0xa1fd, new Instruction("and c", 0xa1fd, 2) },
        { 0xa2fd, new Instruction("and d", 0xa2fd, 2) },
        { 0xa3fd, new Instruction("and e", 0xa3fd, 2) },
        ...
        { 0xa7fd, new Instruction("and a", 0xa7fd, 2) },
        { 0xa8fd, new Instruction("xor b", 0xa9fd, 2) },
        { 0xa9fd, new Instruction("xor c", 0xaafd, 2) },
        { 0xaafd, new Instruction("xor d", 0xabfd, 2) },
        { 0xabfd, new Instruction("xor e", 0xacfd, 2) },
        ...
        { 0xaffd, new Instruction("xor a", 0xaffd, 2) },
        { 0xb0fd, new Instruction("or b", 0xb0fd, 2) },
        { 0xb1fd, new Instruction("or c", 0xb1fd, 2) },
        { 0xb2fd, new Instruction("or d", 0xb2fd, 2) },
        { 0xb3fd, new Instruction("or e", 0xb3fd, 2) },
        { 0xb4fd, new Instruction("or iyh", 0xb4fd,   2) },
        { 0xb5fd, new Instruction("or iyl", 0xb5fd,   2) },
        { 0xb6fd, new Instruction("or (iy+${0:x2})", 0xb6fd,   3) },
        { 0xb7fd, new Instruction("or a", 0xb7fd, 2) },
        { 0xb8fd, new Instruction("cp b", 0xb9fd, 2) },
        { 0xb9fd, new Instruction("cp c", 0xbafd, 2) },
        { 0xbafd, new Instruction("cp d", 0xbbfd, 2) },
        { 0xbbfd, new Instruction("cp e", 0xbcfd, 2) },
        { 0xbcfd, new Instruction("cp iyh", 0xbcfd,   2) },
        { 0xbdfd, new Instruction("cp iyl", 0xbdfd,   2) },
        { 0xbefd, new Instruction("cp (iy+${0:x2})", 0xbefd,   3) },
        { 0xbffd, new Instruction("cp a", 0xbffd, 2) },
        ...
        { 0x40cbdd, new Instruction("bit 0,(ix+${0:x2})", 0x40cbdd, 4) },
        { 0x41cbdd, new Instruction("bit 0,(ix+${0:x2})", 0x41cbdd, 4) },
        { 0x42cbdd, new Instruction("bit 0,(ix+${0:x2})", 0x42cbdd, 4) },
        { 0x43cbdd, new Instruction("bit 0,(ix+${0:x2})", 0x43cbdd, 4) },
        { 0x44cbdd, new Instruction("bit 0,(ix+${0:x2})", 0x44cbdd, 4) },
        { 0x45cbdd, new Instruction("bit 0,(ix+${0:x2})", 0x45cbdd, 4) },
        { 0x46cbdd, new Instruction("bit 0,(ix+${0:x2})", 0x46cbdd, 4) },
        { 0x47cbdd, new Instruction("bit 0,(ix+${0:x2})", 0x47cbdd, 4) },
        { 0x48cbdd, new Instruction("bit 1,(ix+${0:x2})", 0x48cbdd, 4) },
        { 0x49cbdd, new Instruction("bit 1,(ix+${0:x2})", 0x49cbdd, 4) },
        { 0x4acbdd, new Instruction("bit 1,(ix+${0:x2})", 0x4acbdd, 4) },
        { 0x4bcbdd, new Instruction("bit 1,(ix+${0:x2})", 0x4bcbdd, 4) },
        { 0x4ccbdd, new Instruction("bit 1,(ix+${0:x2})", 0x4ccbdd, 4) },
        { 0x4dcbdd, new Instruction("bit 1,(ix+${0:x2})", 0x4dcbdd, 4) },
        { 0x4ecbdd, new Instruction("bit 1,(ix+${0:x2})", 0x4ecbdd, 4) },
        { 0x4fcbdd, new Instruction("bit 1,(ix+${0:x2})", 0x4fcbdd, 4) },
        { 0x50cbdd, new Instruction("bit 2,(ix+${0:x2})", 0x50cbdd, 4) },
        { 0x51cbdd, new Instruction("bit 2,(ix+${0:x2})", 0x51cbdd, 4) },
        { 0x52cbdd, new Instruction("bit 2,(ix+${0:x2})", 0x52cbdd, 4) },
        { 0x53cbdd, new Instruction("bit 2,(ix+${0:x2})", 0x53cbdd, 4) },
        { 0x54cbdd, new Instruction("bit 2,(ix+${0:x2})", 0x54cbdd, 4) },
        { 0x55cbdd, new Instruction("bit 2,(ix+${0:x2})", 0x55cbdd, 4) },
        { 0x56cbdd, new Instruction("bit 2,(ix+${0:x2})", 0x56cbdd, 4) },
        { 0x57cbdd, new Instruction("bit 2,(ix+${0:x2})", 0x57cbdd, 4) },
        { 0x58cbdd, new Instruction("bit 3,(ix+${0:x2})", 0x58cbdd, 4) },
        { 0x59cbdd, new Instruction("bit 3,(ix+${0:x2})", 0x59cbdd, 4) },
        { 0x5acbdd, new Instruction("bit 3,(ix+${0:x2})", 0x5acbdd, 4) },
        { 0x5bcbdd, new Instruction("bit 3,(ix+${0:x2})", 0x5bcbdd, 4) },
        { 0x5ccbdd, new Instruction("bit 3,(ix+${0:x2})", 0x5ccbdd, 4) },
        { 0x5dcbdd, new Instruction("bit 3,(ix+${0:x2})", 0x5dcbdd, 4) },
        { 0x5ecbdd, new Instruction("bit 3,(ix+${0:x2})", 0x5ecbdd, 4) },
        { 0x5fcbdd, new Instruction("bit 3,(ix+${0:x2})", 0x5fcbdd, 4) },
        { 0x60cbdd, new Instruction("bit 4,(ix+${0:x2})", 0x60cbdd, 4) },
        { 0x61cbdd, new Instruction("bit 4,(ix+${0:x2})", 0x61cbdd, 4) },
        { 0x62cbdd, new Instruction("bit 4,(ix+${0:x2})", 0x62cbdd, 4) },
        { 0x63cbdd, new Instruction("bit 4,(ix+${0:x2})", 0x63cbdd, 4) },
        { 0x64cbdd, new Instruction("bit 4,(ix+${0:x2})", 0x64cbdd, 4) },
        { 0x65cbdd, new Instruction("bit 4,(ix+${0:x2})", 0x65cbdd, 4) },
        { 0x66cbdd, new Instruction("bit 4,(ix+${0:x2})", 0x66cbdd, 4) },
        { 0x67cbdd, new Instruction("bit 4,(ix+${0:x2})", 0x67cbdd, 4) },
        { 0x68cbdd, new Instruction("bit 5,(ix+${0:x2})", 0x68cbdd, 4) },
        { 0x69cbdd, new Instruction("bit 5,(ix+${0:x2})", 0x69cbdd, 4) },
        { 0x6acbdd, new Instruction("bit 5,(ix+${0:x2})", 0x6acbdd, 4) },
        { 0x6bcbdd, new Instruction("bit 5,(ix+${0:x2})", 0x6bcbdd, 4) },
        { 0x6ccbdd, new Instruction("bit 5,(ix+${0:x2})", 0x6ccbdd, 4) },
        { 0x6dcbdd, new Instruction("bit 5,(ix+${0:x2})", 0x6dcbdd, 4) },
        { 0x6ecbdd, new Instruction("bit 5,(ix+${0:x2})", 0x6ecbdd, 4) },
        { 0x6fcbdd, new Instruction("bit 5,(ix+${0:x2})", 0x6fcbdd, 4) },
        { 0x70cbdd, new Instruction("bit 6,(ix+${0:x2})", 0x70cbdd, 4) },
        { 0x71cbdd, new Instruction("bit 6,(ix+${0:x2})", 0x71cbdd, 4) },
        { 0x72cbdd, new Instruction("bit 6,(ix+${0:x2})", 0x72cbdd, 4) },
        { 0x73cbdd, new Instruction("bit 6,(ix+${0:x2})", 0x73cbdd, 4) },
        { 0x74cbdd, new Instruction("bit 6,(ix+${0:x2})", 0x74cbdd, 4) },
        { 0x75cbdd, new Instruction("bit 6,(ix+${0:x2})", 0x75cbdd, 4) },
        { 0x76cbdd, new Instruction("bit 6,(ix+${0:x2})", 0x76cbdd, 4) },
        { 0x77cbdd, new Instruction("bit 6,(ix+${0:x2})", 0x77cbdd, 4) },
        { 0x78cbdd, new Instruction("bit 7,(ix+${0:x2})", 0x78cbdd, 4) },
        { 0x79cbdd, new Instruction("bit 7,(ix+${0:x2})", 0x79cbdd, 4) },
        { 0x7acbdd, new Instruction("bit 7,(ix+${0:x2})", 0x7acbdd, 4) },
        { 0x7bcbdd, new Instruction("bit 7,(ix+${0:x2})", 0x7bcbdd, 4) },
        { 0x7ccbdd, new Instruction("bit 7,(ix+${0:x2})", 0x7ccbdd, 4) },
        { 0x7dcbdd, new Instruction("bit 7,(ix+${0:x2})", 0x7dcbdd, 4) },
        { 0x7ecbdd, new Instruction("bit 7,(ix+${0:x2})", 0x7ecbdd, 4) },
        { 0x7fcbdd, new Instruction("bit 7,(ix+${0:x2})", 0x7fcbdd, 4) },
        ...
        { 0x40cbfd, new Instruction("bit 0,(iy+${0:x2})", 0x40cbfd, 4) },
        { 0x41cbfd, new Instruction("bit 0,(iy+${0:x2})", 0x41cbfd, 4) },
        { 0x42cbfd, new Instruction("bit 0,(iy+${0:x2})", 0x42cbfd, 4) },
        { 0x43cbfd, new Instruction("bit 0,(iy+${0:x2})", 0x43cbfd, 4) },
        { 0x44cbfd, new Instruction("bit 0,(iy+${0:x2})", 0x44cbfd, 4) },
        { 0x45cbfd, new Instruction("bit 0,(iy+${0:x2})", 0x45cbfd, 4) },
        { 0x46cbfd, new Instruction("bit 0,(iy+${0:x2})", 0x46cbfd, 4) },
        { 0x47cbfd, new Instruction("bit 0,(iy+${0:x2})", 0x47cbfd, 4) },
        { 0x48cbfd, new Instruction("bit 1,(iy+${0:x2})", 0x48cbfd, 4) },
        { 0x49cbfd, new Instruction("bit 1,(iy+${0:x2})", 0x49cbfd, 4) },
        { 0x4acbfd, new Instruction("bit 1,(iy+${0:x2})", 0x4acbfd, 4) },
        { 0x4bcbfd, new Instruction("bit 1,(iy+${0:x2})", 0x4bcbfd, 4) },
        { 0x4ccbfd, new Instruction("bit 1,(iy+${0:x2})", 0x4ccbfd, 4) },
        { 0x4dcbfd, new Instruction("bit 1,(iy+${0:x2})", 0x4dcbfd, 4) },
        { 0x4ecbfd, new Instruction("bit 1,(iy+${0:x2})", 0x4ecbfd, 4) },
        { 0x4fcbfd, new Instruction("bit 1,(iy+${0:x2})", 0x4fcbfd, 4) },
        { 0x50cbfd, new Instruction("bit 2,(iy+${0:x2})", 0x50cbfd, 4) },
        { 0x51cbfd, new Instruction("bit 2,(iy+${0:x2})", 0x51cbfd, 4) },
        { 0x52cbfd, new Instruction("bit 2,(iy+${0:x2})", 0x52cbfd, 4) },
        { 0x53cbfd, new Instruction("bit 2,(iy+${0:x2})", 0x53cbfd, 4) },
        { 0x54cbfd, new Instruction("bit 2,(iy+${0:x2})", 0x54cbfd, 4) },
        { 0x55cbfd, new Instruction("bit 2,(iy+${0:x2})", 0x55cbfd, 4) },
        { 0x56cbfd, new Instruction("bit 2,(iy+${0:x2})", 0x56cbfd, 4) },
        { 0x57cbfd, new Instruction("bit 2,(iy+${0:x2})", 0x57cbfd, 4) },
        { 0x58cbfd, new Instruction("bit 3,(iy+${0:x2})", 0x58cbfd, 4) },
        { 0x59cbfd, new Instruction("bit 3,(iy+${0:x2})", 0x59cbfd, 4) },
        { 0x5acbfd, new Instruction("bit 3,(iy+${0:x2})", 0x5acbfd, 4) },
        { 0x5bcbfd, new Instruction("bit 3,(iy+${0:x2})", 0x5bcbfd, 4) },
        { 0x5ccbfd, new Instruction("bit 3,(iy+${0:x2})", 0x5ccbfd, 4) },
        { 0x5dcbfd, new Instruction("bit 3,(iy+${0:x2})", 0x5dcbfd, 4) },
        { 0x5ecbfd, new Instruction("bit 3,(iy+${0:x2})", 0x5ecbfd, 4) },
        { 0x5fcbfd, new Instruction("bit 3,(iy+${0:x2})", 0x5fcbfd, 4) },
        { 0x60cbfd, new Instruction("bit 4,(iy+${0:x2})", 0x60cbfd, 4) },
        { 0x61cbfd, new Instruction("bit 4,(iy+${0:x2})", 0x61cbfd, 4) },
        { 0x62cbfd, new Instruction("bit 4,(iy+${0:x2})", 0x62cbfd, 4) },
        { 0x63cbfd, new Instruction("bit 4,(iy+${0:x2})", 0x63cbfd, 4) },
        { 0x64cbfd, new Instruction("bit 4,(iy+${0:x2})", 0x64cbfd, 4) },
        { 0x65cbfd, new Instruction("bit 4,(iy+${0:x2})", 0x65cbfd, 4) },
        { 0x66cbfd, new Instruction("bit 4,(iy+${0:x2})", 0x66cbfd, 4) },
        { 0x67cbfd, new Instruction("bit 4,(iy+${0:x2})", 0x67cbfd, 4) },
        { 0x68cbfd, new Instruction("bit 5,(iy+${0:x2})", 0x68cbfd, 4) },
        { 0x69cbfd, new Instruction("bit 5,(iy+${0:x2})", 0x69cbfd, 4) },
        { 0x6acbfd, new Instruction("bit 5,(iy+${0:x2})", 0x6acbfd, 4) },
        { 0x6bcbfd, new Instruction("bit 5,(iy+${0:x2})", 0x6bcbfd, 4) },
        { 0x6ccbfd, new Instruction("bit 5,(iy+${0:x2})", 0x6ccbfd, 4) },
        { 0x6dcbfd, new Instruction("bit 5,(iy+${0:x2})", 0x6dcbfd, 4) },
        { 0x6ecbfd, new Instruction("bit 5,(iy+${0:x2})", 0x6ecbfd, 4) },
        { 0x6fcbfd, new Instruction("bit 5,(iy+${0:x2})", 0x6fcbfd, 4) },
        { 0x70cbfd, new Instruction("bit 6,(iy+${0:x2})", 0x70cbfd, 4) },
        { 0x71cbfd, new Instruction("bit 6,(iy+${0:x2})", 0x71cbfd, 4) },
        { 0x72cbfd, new Instruction("bit 6,(iy+${0:x2})", 0x72cbfd, 4) },
        { 0x73cbfd, new Instruction("bit 6,(iy+${0:x2})", 0x73cbfd, 4) },
        { 0x74cbfd, new Instruction("bit 6,(iy+${0:x2})", 0x74cbfd, 4) },
        { 0x75cbfd, new Instruction("bit 6,(iy+${0:x2})", 0x75cbfd, 4) },
        { 0x76cbfd, new Instruction("bit 6,(iy+${0:x2})", 0x76cbfd, 4) },
        { 0x77cbfd, new Instruction("bit 6,(iy+${0:x2})", 0x77cbfd, 4) },
        { 0x78cbfd, new Instruction("bit 7,(iy+${0:x2})", 0x78cbfd, 4) },
        { 0x79cbfd, new Instruction("bit 7,(iy+${0:x2})", 0x79cbfd, 4) },
        { 0x7acbfd, new Instruction("bit 7,(iy+${0:x2})", 0x7acbfd, 4) },
        { 0x7bcbfd, new Instruction("bit 7,(iy+${0:x2})", 0x7bcbfd, 4) },
        { 0x7ccbfd, new Instruction("bit 7,(iy+${0:x2})", 0x7ccbfd, 4) },
        { 0x7dcbfd, new Instruction("bit 7,(iy+${0:x2})", 0x7dcbfd, 4) },
        { 0x7ecbfd, new Instruction("bit 7,(iy+${0:x2})", 0x7ecbfd, 4) },
        { 0x7fcbfd, new Instruction("bit 7,(iy+${0:x2})", 0x7fcbfd, 4) },
    ...
    private static readonly Dictionary<ulong, int> s_i8080 = new()
    {
         ...
         { (ulong)SyntaxParser.LXI << 32 | Z80Modes.BC0N161, 0x01 },
         { (ulong)SyntaxParser.LXI << 32 | Z80Modes.DE0N161, 0x11 },
         { (ulong)SyntaxParser.LXI << 32 | Z80Modes.HL0N161, 0x21 },
         ...
         { (ulong)SyntaxParser.RST << 32 | Z80Modes.N80, 0xcf },
    ...
    private static readonly Dictionary<int, Instruction> s_i8080allOpcodes = new()
    {
        ...
        { 0x08, new Instruction("nop", 0x08,  1) },
        ...
        { 0x10, new Instruction("nop", 0x10,  1) },
        ...
        { 0x18, new Instruction("nop", 0x18,  1) },
        ...
        { 0x20, new Instruction("nop", 0x20,  1) },
        ...
        { 0x27, new Instruction("daa", 0x27,  1) },
        { 0x28, new Instruction("nop", 0x28,  1) },
        ...
        { 0x30, new Instruction("nop", 0x30,  1) },
        ...
        { 0x38, new Instruction("nop", 0x38,  1) },
        ...
        { 0xe7, new Instruction("rst 4", 0xe7, 1) },
        ...
        { 0xed, new Instruction("call ${0:x4}", 0xed,  3) },
        { 0xee, new Instruction("xri ${0:x2}", 0xee,  2) },
        { 0xef, new Instruction("rst 5", 0xef, 1) },
        ...
        { 0xf7, new Instruction("rst 6", 0xf7, 1) },
        ...
        { 0xfd, new Instruction("call ${0:x4}", 0xfd,  3) },
        { 0xfe, new Instruction("cpi ${0:x2}", 0xfe,  2) },
        { 0xff, new Instruction("rst 7", 0xff, 1) }
    };
    ...
    private static readonly Dictionary<int, Instruction> s_gb80AllOpcodes = new()
    {
        ...
        { 0xe6, new Instruction("and ${0:x2}", 0xe6,    2) },
        { 0xe7, new Instruction("rst $20", 0xe7, 1) },
        { 0xe8, new Instruction("add sp,${0:x2}", 0xe8, 2) },
        { 0xe9, new Instruction("jp hl", 0xe9,    1) },
