...
/// <summary>
/// Responsible for formatting binary output as a .D64 formatted disk.
/// </summary>
public sealed class D64FormatProvider : IOutputFormatProvider
{
    static readonly Dictionary<int, int> s_trackSectorTable = new()
    {
        { 1, 21 },
        { 2, 21 },
        { 3, 21 },
    ...
    /// </summary>
    public const int DirectorySector = 18;

    /// <summary>
    /// Get the directory offset in the binary file.
    /// </summary>
    public const int DirectoryOffset = 0x16500;

    /// <summary>
    /// Get the BAM size
    /// </summary>
    public const int BAMSize = 139;

    /// <summary>
    /// Get the disk size.
    /// </summary>
    public const int DiskSize = 683 * 256;
    ...
    public ReadOnlyCollection<byte> GetFormat(OutputFormatInfo info)
    {
        ...
        return new ReadOnlyCollection<byte>(diskImage);
    }

    public string FormatName => "d64";
}
