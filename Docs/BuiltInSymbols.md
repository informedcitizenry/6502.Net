...
| Name          | Value                                     |
|---------------|-------------------------------------------|
| \_\_CPUID\_\_ | The current target CPU                    |
| \_\_FILE\_\_  | The current source filename               |
| \_\_LINE\_\_  | The current line in the source file       |
...
Generate a random number within the specified range of numbers. Both arguments can be negative or positive, but the second argument must be greater than the first, and the difference between them can be no greater than the maximum value of a signed 32-bit integer.
