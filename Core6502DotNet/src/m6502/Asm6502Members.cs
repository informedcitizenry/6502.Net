...
namespace Core6502DotNet.m6502
{
    ...
    public sealed partial class Asm6502 : AssemblerBase
    {
        enum Modes
        {
            ...
            Zp6 = TwoOperand | Bit6,
            Zp7 = TwoOperand | Bit7,
            ThreeOp0 = ThreeOperand,
            ThreeOp1 = ThreeOperand | Bit1,
            ThreeOp2 = ThreeOperand | Bit2,
            ThreeOp3 = ThreeOperand | Bit3,
            ThreeOp4 = ThreeOperand | Bit4,
            ThreeOp5 = ThreeOperand | Bit5,
            ThreeOp6 = ThreeOperand | Bit6,
            ThreeOp7 = ThreeOperand | Bit7,
            BitOpMask = ThreeOperand | TwoOperand | Bit7,
        ...
        static readonly Dictionary<MnemMode, CpuInstruction> _opcodesR65C02 = new Dictionary<MnemMode, CpuInstruction>()
        {
            ...
            { new MnemMode("bbr", Modes.ThreeOp0    ), new CpuInstruction( "R65C02",  0x0f, 3) },
            { new MnemMode("rmb", Modes.Zp1         ), new CpuInstruction( "R65C02",  0x17, 2) },
            { new MnemMode("bbr", Modes.ThreeOp1    ), new CpuInstruction( "R65C02",  0x1f, 3) },
            { new MnemMode("rmb", Modes.Zp2         ), new CpuInstruction( "R65C02",  0x27, 2) },
            { new MnemMode("bbr", Modes.ThreeOp2    ), new CpuInstruction( "R65C02",  0x2f, 3) },
            { new MnemMode("rmb", Modes.Zp3         ), new CpuInstruction( "R65C02",  0x37, 2) },
            { new MnemMode("bbr", Modes.ThreeOp3    ), new CpuInstruction( "R65C02",  0x3f, 3) },
            { new MnemMode("rmb", Modes.Zp4         ), new CpuInstruction( "R65C02",  0x47, 2) },
            { new MnemMode("bbr", Modes.ThreeOp4    ), new CpuInstruction( "R65C02",  0x4f, 3) },
            { new MnemMode("rmb", Modes.Zp5         ), new CpuInstruction( "R65C02",  0x57, 2) },
            { new MnemMode("bbr", Modes.ThreeOp5    ), new CpuInstruction( "R65C02",  0x5f, 3) },
            { new MnemMode("rmb", Modes.Zp6         ), new CpuInstruction( "R65C02",  0x67, 2) },
            { new MnemMode("bbr", Modes.ThreeOp6    ), new CpuInstruction( "R65C02",  0x6f, 3) },
            { new MnemMode("rmb", Modes.Zp7         ), new CpuInstruction( "R65C02",  0x77, 2) },
            { new MnemMode("bbr", Modes.ThreeOp7    ), new CpuInstruction( "R65C02",  0x7f, 3) },
            { new MnemMode("smb", Modes.Zp0         ), new CpuInstruction( "R65C02",  0x87, 2) },
            { new MnemMode("bbs", Modes.ThreeOp0    ), new CpuInstruction( "R65C02",  0x8f, 3) },
            { new MnemMode("smb", Modes.Zp1         ), new CpuInstruction( "R65C02",  0x97, 2) },
            { new MnemMode("bbs", Modes.ThreeOp1    ), new CpuInstruction( "R65C02",  0x9f, 3) },
            { new MnemMode("smb", Modes.Zp2         ), new CpuInstruction( "R65C02",  0xa7, 2) },
            { new MnemMode("bbs", Modes.ThreeOp2    ), new CpuInstruction( "R65C02",  0xaf, 3) },
            { new MnemMode("smb", Modes.Zp3         ), new CpuInstruction( "R65C02",  0xb7, 2) },
            { new MnemMode("bbs", Modes.ThreeOp3    ), new CpuInstruction( "R65C02",  0xbf, 3) },
            { new MnemMode("smb", Modes.Zp4         ), new CpuInstruction( "R65C02",  0xc7, 2) },
            { new MnemMode("bbs", Modes.ThreeOp4    ), new CpuInstruction( "R65C02",  0xcf, 3) },
            { new MnemMode("smb", Modes.Zp5         ), new CpuInstruction( "R65C02",  0xd7, 2) },
            { new MnemMode("bbs", Modes.ThreeOp5    ), new CpuInstruction( "R65C02",  0xdf, 3) },
            { new MnemMode("smb", Modes.Zp6         ), new CpuInstruction( "R65C02",  0xe7, 2) },
            { new MnemMode("bbs", Modes.ThreeOp6    ), new CpuInstruction( "R65C02",  0xef, 3) },
            { new MnemMode("smb", Modes.Zp7         ), new CpuInstruction( "R65C02",  0xf7, 2) },
            { new MnemMode("bbs", Modes.ThreeOp7    ), new CpuInstruction( "R65C02",  0xff, 3) },
        };
        ...
        static readonly Dictionary<Modes, string> _modeFormats = new Dictionary<Modes, string>
        {
            ...
            { Modes.ThreeOp0,       "0,${0:x2},${1:x2}"         },
            { Modes.ThreeOp1,       "1,${0:x2},${1:x2}"         },
            { Modes.ThreeOp2,       "2,${0:x2},${1:x2}"         },
            { Modes.ThreeOp3,       "3,${0:x2},${1:x2}"         },
            { Modes.ThreeOp4,       "4,${0:x2},${1:x2}"         },
            { Modes.ThreeOp5,       "5,${0:x2},${1:x2}"         },
            { Modes.ThreeOp6,       "6,${0:x2},${1:x2}"         },
            { Modes.ThreeOp7,       "7,${0:x2},${1:x2}"         },
