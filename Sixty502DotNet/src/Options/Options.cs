...
namespace Sixty502DotNet
{
    ...
    public sealed class Options : JsonSerializable
    {
        ...
        public sealed class Listing
        {
            ...
            /// <summary>
            /// Gets the label addresses only flag.
            /// </summary>
        ...
        public sealed class Logging
        {
            ...
            /// <param name="enableAllWarnings">The enable all warnings flag.</param>
            /// <param name="checksum">The checksum flag.</param>
            /// <param name="noHighlighting">The no-highlighting flag.</param>
            ...
            /// <param name="warnAboutAmbiguousZeroPageOperands">The warn about ambiguous zero page operands flag.</param>
            /// <param name="warnAboutJumpBug">The warn about jump bug flag.</param>
            /// <param name="warnAboutUsingTextInNonTextPseudoOps">The warn about using text in non-text pseudo-ops flag.</param>
            ...
            /// <param name="warnSimplifyCallReturn">The warn on simplify call and return flag.</param>
            /// <param name="warnUnreferencedSymbols">The warn about unreferended symbols flag.</param>
            [JsonConstructor]
            public Logging(string? errorPath,
                           ...
                           bool noWarnings,
                           bool quietMode,
                           bool warnAboutAmbiguousZeroPageOperands,
                           bool warnAboutJumpBug,
                           bool warnAboutUsingTextInNonTextPseudoOps,
                           bool warningsAsErrors,
                           bool warnLeft,
                           bool suppressUnusedSectionWarning,
                           bool warnCaseMismatch,
                           bool warnSimplifyCallReturn,
                           bool warnUnreferencedSymbols)
            {
                ...
                {
                    WarnAboutAmbiguousZeroPageOperands =
                    WarnAboutJumpBug =
                    WarnAboutUsingTextInNonTextPseudoOps =
                    WarnLeft = WarnCaseMismatch =
                    WarnSimplifyCallReturn = WarnUnreferencedSymbols = true;
                }
                else
                {
                    WarnAboutAmbiguousZeroPageOperands = warnAboutAmbiguousZeroPageOperands;
                    WarnAboutJumpBug = warnAboutJumpBug;
                    WarnAboutUsingTextInNonTextPseudoOps = warnAboutUsingTextInNonTextPseudoOps;
                    WarnLeft = warnLeft;
                    WarnCaseMismatch = warnCaseMismatch;
                    WarnSimplifyCallReturn = warnSimplifyCallReturn;
                    WarnUnreferencedSymbols = warnUnreferencedSymbols;
                }
            ...
            /// <summary>
            /// Gets the enable all warnings flag.
            /// </summary>
            public bool EnableAllWarnings { get; }
            ...
            /// <summary>
            /// Gets the no-highlighting flag.
            /// </summary>
            public bool NoHighlighting { get; }
            ...
            /// <summary>
            /// Gets the warn about ambiguous zeropage operands flag.
            /// </summary>
            public bool WarnAboutAmbiguousZeroPageOperands { get; }

            /// <summary>
            /// Gets the warn about jump bug flag.
            /// </summary>
            public bool WarnAboutJumpBug { get; }

            /// <summary>
            /// Gets the warn about using text in non-text pseudo-ops flag.
            /// </summary>
            public bool WarnAboutUsingTextInNonTextPseudoOps { get; }
            ...
            /// <summary>
            /// Gets the warn on simplify call and return flag.
            /// </summary>
            public bool WarnSimplifyCallReturn { get; }

            /// <summary>
            /// Gets the warn about unreferenced symbols flag.
            /// </summary>
            public bool WarnUnreferencedSymbols { get; }
        }
        ...
        /// <summary>
        /// Constructs an instance of the <see cref="Options"/> class.
        /// </summary>
        ...
        /// <param name="warnCaseMismatch">The warn on symbol case mismatch flag.</param>
        /// <param name="warnAboutUsingTextInNonTextPseudoOps">The warn about using text in non-text pseudo-ops flag.</param>
        /// <param name="warnSimplifyCallReturn">The warn about simplify call and return flag.</param>
        public Options(IList<string>? inputFiles,
                       ...
                       bool warnAboutUsingTextInNonTextPseudoOps,
                       bool warnSimplifyCallReturn,
                       bool warnUnreferencedSymbols) : this(inputFiles,
        ...
        /// <param name="caseSensitive">The case-sensitive flag.</param>
        /// <param name="preprocessOnly">The pre-process only flag.</param>
        /// <param name="outputFile">The output filename.</param>
        /// <param name="outputSection">The section to output.</param>
                       ...
                       bool resetPcOnBank)
        {
            ...
            Patch = patchOffset;
            Defines = GetReadOnlyList(defines);
            ...
            try
            {
                ...
                _ = result.WithParsed(o =>
                {
                    ...
                    else
                    {
                        ...
                        var validator = new JsonValidator(ConfigReader.Schema());
                        options = validator.ValidateAndDeserialize<Options>(o.ConfigFile, out var errors);
                        if (errors.Any() || options == null)
        ...
        /// <summary>
        /// Gets the read-only list of defined symbols.
        /// </summary>
        [JsonProperty]
        [Option('D', "define", Separator = ':', Required = false, HelpText = "Assign value to a global constant in <args>.", MetaValue = "<arg>.")]
        public ReadOnlyCollection<string>? Defines { get; }
        ...
        /// <summary>
        /// Gets the flag indicating to stop at preprocessing.
        /// </summary>
        [JsonProperty]
        [Option('E', Required = false, HelpText = "Preprocess source to output stream only.")]
        public bool PreprocessOnly { get; }
        ...
        /// as comments.
        /// </summary>
        [Option("ignore-colons", Required = false, Default = null, Hidden = true)]
        ...
        /// <summary>
        /// Gets the flag indicating whether to highlight causes of errors and warnings in source.
        /// </summary>
        [Option("no-highlighting", Required = false, HelpText = "Do not highlight causes of errors and warnings in source.")]
        public bool NoHighlighting => _logging?.NoHighlighting == true;
        ...
        /// <summary>
        /// Gets the flag indicating all other warning options are enabled.
        /// </summary>
        [Option("Wall", Required = false, HelpText = "Enable all warnings.")]
        public bool EnableAllWarnings => _logging?.EnableAllWarnings == true;

        /// <summary>
        /// Gets the flag to warn about usage of ambiguous zeropage operands.
        /// </summary>
        [Option("Wambiguous-zp", Required = false, HelpText = "Warn when arguments could be zeropage or absolute.")]
        public bool WarnAboutAmbiguousZeroPageOperands => _logging?.WarnAboutAmbiguousZeroPageOperands == true;
        ...
        /// <summary>
        /// Gets the flag that indicates the assembler should issue a warning when the JMP bug.
        /// </summary>
        [Option("Wjump-bug", Required = false, HelpText = "Warn about the JMP bug in 6502 mode.")]
        public bool WarnAboutJumpBug => _logging?.WarnAboutJumpBug == true;
        ...
        /// <summary>
        /// Gets the flag indicating whether to warn whether a call and return can be simplified to a jump.
        /// </summary>
        [Option("Wsimplify-call-return", Required = false, HelpText = "Warn when call and return can be simplified to jump.")]
        public bool WarnSimplifyCallReturn => _logging?.WarnSimplifyCallReturn == true;

        /// <summary>
        /// Gets the flag that warns when a non- .Xstring pseudo op contains text arguments.
        /// </summary>
        [Option("Wtext-in-non-text-pseudo-ops", Required = false, HelpText = "Warn about usage of text in pseudo-ops.")]
        public bool WarnAboutUsingTextInNonTextPseudoOps => _logging?.WarnAboutUsingTextInNonTextPseudoOps == true;

        /// <summary>
        /// Gets the flag that warns about unreferenced symbols.
        /// </summary>
        [Option("Wunreferenced-symbols", Required = false, HelpText = "Warn about unreferenced symbols.")]
        public bool WarnUnreferencedSymbols => _logging?.WarnUnreferencedSymbols == true;
        ...
        public static IEnumerable<Example> Examples
        {
            get
            {
                ...
                yield return new Example("From Config", new Options(null, false, false, false, null, null, false, "config.json", null, false, null, false, false, null, null, null, false, null, false, null, false, false, false, null, null, null, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false));
            }
        }
    }
}
