...
namespace Sixty502DotNet
{
    ...
    public sealed class Schema : JsonSerializable
    {
        ...
        private Schema(bool autoEvaluation)
            : this()
        {
            _jsonPointer = "#";
        ...
        private Schema(bool autoEvaluation, Schema parent)
            : this()
        {
        ...
        private Schema(JToken? token, Schema? parent)
            : this()
        {
            if (token == null)
            {
            ...
            else
            {
                ...
                if (token.HasValues)
                {
                    ...
                    Type = GetProperty<JToken>(obj, "type") ?? JToken.Parse("{}");
                    _type = ConvertType();
                    Validate();
                }
            }
        ...
        {
            if (absolute)
                return _basePathIsAbsoluteUri ? _basePath ?? "/" : "/";
            return _jsonPointer;
        }
        ...
        public static implicit operator Schema(bool autoEvaluate) => new(autoEvaluate);
